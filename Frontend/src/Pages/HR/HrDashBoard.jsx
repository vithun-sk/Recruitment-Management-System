...
const HrDashBoard = () => {
  ...
  const stats = [
    ...
    { label: "Jobs Posted by You ", value: "7" }]
  return (
    <>
      <HrNav />
      <div className='hr-dashboard'>
        ...
        <section className='hr-dash-btns'>
          <div className="hr-button-actions">
            <button className="postJob-btn" onClick={()=>navigate('/hr/jobs')}>Post a New Job</button>
            <button className="reviewApp-btn" onClick={()=>navigate('/hr/applications')}>Review Applications</button>
          </div>
        </section>
        ...
        <section >
          ...
          <div className='hr-dash-intro'>
            <article className='hr-intro'>
              ...
              <p>
                Our <strong>Real-Time Status Tracking</strong> system ensures you never lose
                sight of a top-tier candidate. Monitor every stage-from the initial application
                to the final offer-with a transparent pipeline designed for speed and precision.
              </p>
            </article>
